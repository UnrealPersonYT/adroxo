...
/// @brief       Mixes a 64-bit `state` for `r` rounds
/// @param state 64-bit buffer to mix
/// @param r     Total rounds to mix
extern void adroxo64_r(void* __restrict state, size_t r);
/// @brief       Mixes a 64-bit `state` for `ADROXO_GENERIC_ROUNDS` round
/// @param state 64-bit buffer to mix
extern void adroxo64(void* __restrict state);
/// @brief       Mixes a 32-bit `state` for `r` rounds
/// @param state 32-bit buffer to mix
/// @param r     Total rounds to mix
extern void adroxo32_r(void* __restrict state, size_t r);
/// @brief       Mixes a 32-bit `state` for `ADROXO_GENERIC_ROUNDS` round
/// @param state 32-bit buffer to mix
extern void adroxo32(void* __restrict state);
